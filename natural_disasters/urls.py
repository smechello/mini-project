"""Nutrition_project URL Configuration
...
urlpatterns = [
    ...
    path('reactivate/<str:uidb64>/',views.reactivate_acc,name='reactivate_account'),
    path('mailsend/',views.active_mail,name='mail_send'),
    path('raise-alert',views.raise_alert,name="raise_alert"),
    path('recent-alert',views.recent_alert,name="recent_alert"),
